...
if __name__ == "__main__":
    ...
    total_conqu = alice.union(bob).union(charlie).union(dylan)
    print(f"\nAll distinct achievements: {total_conqu}")

    # Var para ver a conquista que todos tem igual.
    igual = alice.intersection(bob).intersection(charlie).intersection(dylan)
